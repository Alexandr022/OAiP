...
int initializeStructByHand()
{
    ...
    for (size_t i = 0; i < size; i++)
    {
        ...
        laptops->laptops[i].resolution[0] = validateInputValues1(1024, 1920, 2560);
        ...
        laptops->laptops[i].frequency = validateInputValues2(60, 120, 144, 160);
        ...
        printf("Enter a RAM size (4, 8, 16, 32).\n");
        laptops->laptops[i].ramsize = validateInputValues2(4, 8, 16, 32);
        ...
        laptops->laptops[i].storagesize = validateInputValues2(128, 256, 512, 1024);
        ...
        laptops->laptops[i].vram = validateInputValues2(4, 6, 8, 12);
